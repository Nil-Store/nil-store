                ...
                <button
                  onClick={async () => {
                    ...
                    if (isMode2) {
                      ...
                      const totalMdus = 1 + witnessMdus + shardProgress.totalUserMdus
                      if (totalMdus <= 1 + witnessMdus) {
                        addLog('Commit blocked: missing slab layout metadata (total MDUs / witness MDUs). Re-upload and try again.')
                        return
                      }
                    }
                    ...
                    try {
                      await commitContent({
                        ...
                        manifestRoot: currentManifestRoot || '',
                        fileSize: totalSize,
                        totalMdus: isMode2 ? 1 + shardProgress.totalWitnessMdus + shardProgress.totalUserMdus : undefined,
                        witnessMdus: isMode2 ? shardProgress.totalWitnessMdus : undefined,
                      })
                    } catch (e: unknown) {
                      const msg = e instanceof Error ? e.message : String(e)
